(function(){
  ...
  gitFork.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=sun-venus-earth&type=fork&count=true');
  ...
  gitWatch.setAttribute('src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=sun-venus-earth&type=watch&count=true');
